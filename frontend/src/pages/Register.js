...
export const Register = () => {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      const response = await authService.register(name, email, phone, password, otp, tenantCode);
      ...
      >
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">Hostel Code</label>
              <input
                type="text"
                value={tenantCode}
